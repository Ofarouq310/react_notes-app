...
# 📖 Notes Application <a name="about-project"></a>

- A notes app that is granted to the user with the ability to perform complete CRUD functionalities(Create, Read, Update, and Delete). Built with the assistance of third-party libiraries including: 'react-mde' and 'react-split'.
